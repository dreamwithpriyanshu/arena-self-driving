...
def main() -> int:
    """Run all smoke tests; return 0 on success, 1 on failure."""
    print("=" * 60)
    print("  Build Step 1 Smoke Test -- Environment, Actions & State")
    print("=" * 60)

    tests = [
        test_actions,
        test_env_create_and_reset,
        test_stepping,
        test_render_data,
        test_state_builder_edge_cases,
    ]
